...
export default function PatchModal(props) {
  ...
  return (
    <>
      {props.expired ? (
        <button
          className="bg-blue-200 text-white mt-5 active:bg-blue-300 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
          type="button"
